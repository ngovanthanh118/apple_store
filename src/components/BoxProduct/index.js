    ...
    return (
        <div className="flex flex-col bg-white rounded-lg border-gray-300 border-2 border-solid shadow-md box-product">
            <div className="relative ">
                <img className="img-product cursor-pointer" src={"https://apple-store-server-8705f39d5697.herokuapp.com/api/v1/images/" + product.image} alt='' onClick={() => navigate('/product/' + product._id)} />
